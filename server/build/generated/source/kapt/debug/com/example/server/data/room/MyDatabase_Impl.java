  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `config` (`logs` TEXT NOT NULL, PRIMARY KEY(`logs`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'b6a3cc235f90ec836c703e4c757da857')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsConfig = new HashMap<String, TableInfo.Column>(1);
        _columnsConfig.put("logs", new TableInfo.Column("logs", "TEXT", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (!_infoConfig.equals(_existingConfig)) {
          return new RoomOpenHelper.ValidationResult(false, "config(com.example.server.data.models.LogsModel).\n"
                  + " Expected:\n" + _infoConfig + "\n"
                  + " Found:\n" + _existingConfig);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "b6a3cc235f90ec836c703e4c757da857", "1dc2e80f9bc2ef9976e7263e24a5a41b");
